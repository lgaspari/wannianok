...
allstr[13]=g1.indexOf(allstr[12].substr(0,1))+1; //20190705 index+1
allstr[14]=z1.indexOf(allstr[12].substr(1,1))+1; //20190705 index+1
allstr[15] = cld[d].cMonth;
allstr[16]=g1.indexOf(allstr[15].substr(0,1))+1; //20190705 index+1
allstr[17]=z1.indexOf(allstr[15].substr(1,1))+1; //20190705 index+1
allstr[18] = cld[d].cDay;
allstr[19]=g1.indexOf(allstr[18].substr(0,1))+1; //20190705 index+1
allstr[20]=z1.indexOf(allstr[18].substr(1,1))+1; //20190705 index+1
allstr[21] =rtgan1+z11;
allstr[22]=g1.indexOf(allstr[21].substr(0,1))+1; //20190705 index+1
allstr[23]=z1.indexOf(allstr[21].substr(1,1))+1; //20190705 index+1
